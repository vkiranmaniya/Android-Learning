...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder> {
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int i) {
        ...
        holder.actorDOB.setText(mActorData.get(i).getDob());
        holder.actorChild.setText(mActorData.get(i).getChildren());
        holder.actorCountry.setText(mActorData.get(i).getCountry());
        holder.actorHeight.setText(mActorData.get(i).getHeight());
        holder.actorWife.setText(mActorData.get(i).getSpouse());
        holder.actorDesc.setText(mActorData.get(i).getDescription());
